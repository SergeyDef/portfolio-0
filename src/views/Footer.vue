		...
		<div class="feedback">
			<form class="feedback__form">
				...
				<div class="col-sm-12">
					...
					<input type="text" name="name" class="form-control feedback__input" placeholder="Иван" />
				</div>
				</div>
				<div class="feedback__field form-group row">
					<div class="col-sm-12">
						...
						<input type="text" name="surname" class="form-control feedback__input" placeholder="Иванович" />
					</div>
				</div>
				<div class="feedback__field form-group row">
					<div class="col-sm-12">
						<label for="surname" class="feedback__label">
							<span>Почта или email:</span>
						</label>
						<input type="text" name="surname" class="form-control feedback__input" placeholder="" />
					</div>
				</div>
					<div class="feedback__field form-group row">
						<div class="feedback__label col-sm-12">
							<span>Напишите нам:</span>
							<textarea name="massage" placeholder="Ваше сообщение" rows="4" cols="25" class="feedback__massage form-control"></textarea>
						</div>
					</div>
					<div class="feedback__field form-group row">
